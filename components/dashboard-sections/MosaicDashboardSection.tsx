...
const MosaicLayout = getLayoutComponent("everyday");

export default function MosaicDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Mosaic preview — no box, blends into page */}
      <div
