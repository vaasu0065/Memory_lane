...
const CarouselLayout = getLayoutComponent("carousel");

export default function CarouselDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Carousel preview — no box, blends into page */}
      <div
