...
const CoverFlowLayout = getLayoutComponent("cover-flow");

export default function CoverFlowDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Cover Flow preview — no box, blends into page */}
      <div
