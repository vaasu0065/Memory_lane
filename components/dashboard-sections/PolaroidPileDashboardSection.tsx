...
const PolaroidPileLayout = getLayoutComponent("event");

export default function PolaroidPileDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Polaroid Pile preview — no box, blends into page */}
      <div
