...
const TwistedFilmstrip = getLayoutComponent("ribbon");

export default function RibbonDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Ribbon Loop preview — no box, blends into page */}
      <div
