...
import FloatingBubblesLayout from "@/components/layouts/FloatingBubblesLayout";

export default function FloatingBubblesDashboardSection({ section }: { section: any }) {
  return (
    <section
