...
const FilmstripLayout = getLayoutComponent("travel");

export default function FilmstripDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Filmstrip preview — no box, blends into page */}
      <div
