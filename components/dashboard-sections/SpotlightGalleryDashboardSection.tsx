...
const SpotlightGalleryLayout = getLayoutComponent("spotlight");

export default function SpotlightGalleryDashboardSection({ section }: { section: any }) {
  return (
    <section
    ...
    >
      ...
      {/* RIGHT SIDE: Spotlight Gallery template preview — strictly contained */}
      <div
        className="w-full md:w-[65%] flex-shrink-0 relative overflow-hidden rounded-2xl"
        style={{ height: 560, zIndex: 10 }}
      >
